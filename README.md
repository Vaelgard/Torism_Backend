...
curl -X GET http://localhost:8081/api/places
...
curl -X POST http://localhost:8081/api/places \
-H "Authorization: Bearer
eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJuaXphckBlbWFpbC5jb20iLCJpYXQiOjE3MzU2MzU4NTMsImV4cCI6MTczNTcyMjI1M30.erUjUSWzwnFTfaXnR25IFRePTF9y0TYO6MhTm2cIu3k" \
...
curl -X POST http://localhost:8081/api/comments/upvote/{id} \
-H "Authorization: Bearer YOUR_JWT_TOKEN"

# Downvote comment

curl -X POST http://localhost:8081/api/comments/downvote/{id} \
-H "Authorization: Bearer YOUR_JWT_TOKEN"
